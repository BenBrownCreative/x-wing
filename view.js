...
export default class View {
    constructor() {
        this.bg = Sprite('assets/backgroundStars')
        this.flappy = Sprite('assets/x-wing/frames/xwing_', 91)
        //this.flappy = Sprite('assets/xwing', 40)
        this.spike = Sprite('assets/spike')
        this.coin = Sprite('assets/coin', 10)
    } 

    render(game, ctx) {
        const flappyFrame = Math.floor(performance.now() / 35) % this.flappy.length
